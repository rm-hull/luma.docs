...
setup(
    ...
    description=("Documentation source for luma.core and display drivers"),
    long_description="\n\n".join([README, CONTRIB, CHANGES]),
    license="MIT",
    keywords="raspberry orange banana pi rpi opi sbc oled lcd led display screen spi i2c",
    url="https://github.com/rm-hull/luma.docs",
    download_url="https://github.com/rm-hull/luma.docs/tarball/" + version,
